...
/* *
int traLED1 = 2; // position led1 (verte)
int traLED2 = 3; // position led2 (bleue)
// */
...
double traVal0; // gauche
double traVal1; // droit
double traVal2; // hauteur
...
void loop(){
  ...
  /* *
  Serial.print("0 : "); Serial.println(valPOT0);
  Serial.print("1 : "); Serial.println(valPOT1);
  Serial.print("2 : "); Serial.println(valPOT2);
  // */
  //Serial.println("droite  : " + traVal1);
  //Serial.println("hauteur : " + traVal2);
